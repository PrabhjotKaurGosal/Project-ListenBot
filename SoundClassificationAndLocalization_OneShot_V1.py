...
# In this version of the file, the sound is recorded ONCE, processed by the GCC-PHAT to find the time delay (TDOA) between different channels and an
...
if __name__ =="__main__":
    ...
    #  Classify sound using PANNs neural nets
        ...
        sound_type, confidence_score = SoundClassification_.classifyAudio_main()  ## Returns the sound type that has the highest confidence
    ...
    #  Move Misty's body towards the sound source (given by the direction of arrival of sound)
        ...
        misty.DriveArc(absolute_angle, 0, time, False) 
        # misty.Stop()
        print("Misty moved!")
        
        ## Move FORWARD in a straight line until the sound source is reached - TO BE IMPLEMENTED

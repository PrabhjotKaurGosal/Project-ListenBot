...
# The angles are caluclated using all three equations (T1, T2, T3). This is not the final code. It is used for debugging only.
...
def CalculateDOA(ch1,ch2,ch3, sfreq):
    ...
    if T1 > 0 and T2 > 0:
        ...
        if cos_domain_check_T1 < d13:
            ...
            relative_angle_gccPhat_T1 = angle_gccPhat_T1 + 90 
            print("The estimated DOA using T1 is: ", relative_angle_gccPhat_T1 )
        else:
            print("It has Math Domain Error in T1")

        #Use T2
        if cos_domain_check_T2 < d23:
            angle_gccPhat_T2 = math.degrees(math.acos(abs(T2) * 343 / d23))
            relative_angle_gccPhat_T2 = 180 - angle_gccPhat_T2 
            print("The estimated DOA using T2 is: ", relative_angle_gccPhat_T2 )
        else:
            print("It has Math Domain Error in T2")

        #Use T3
        if cos_domain_check_T3 < d12:
            angle_gccPhat_T3 = math.degrees(math.acos(abs(T3) * 343 / d12))
            if T3 < 0:
                relative_angle_gccPhat_T3 = 270 - (angle_gccPhat_T3 + angle_ch1)
                print("The estimated DOA using T3 is: ", relative_angle_gccPhat_T3 )
            else:
                relative_angle_gccPhat_T3 = angle_gccPhat_T3 + angle_ch2
                print("The estimated DOA using T3 is: ", relative_angle_gccPhat_T3 )
        else:
            print("It has Math Domain Error in T3")

        cos_domain_check = abs(T1*343)
        if (cos_domain_check<d13):
        ...
        if cos_domain_check_T1 < d13:
            angle_gccPhat_T1 = math.degrees(math.acos(abs(T1) * 343 / d13))
            relative_angle_gccPhat_T1 = (90 + angle_gccPhat_T1) * (-1)
            print("The estimated DOA using T1 is: ", relative_angle_gccPhat_T1 )
        else:
            print("It has Math Domain Error in T1")
        ...
        if cos_domain_check_T2 < d23:
            angle_gccPhat_T2 = math.degrees(math.acos(abs(T2) * 343 / d23))
            relative_angle_gccPhat_T2 = (180 - angle_gccPhat_T2) * (-1)
            print("The estimated DOA using T2 is: ", relative_angle_gccPhat_T2 )
        else:
            print("It has Math Domain Error in T2")
        ...
        angle_gccPhat_T3 = math.degrees(math.acos(abs(T3) * 343 / d12))
        angle_gccPhat_T2 = math.degrees(math.acos(abs(T2) * 343 / d23))
        if angle_gccPhat_T2 > angle_ch2:
            relative_angle_gccPhat_T3 = (90 + angle_gccPhat_T3 + angle_ch1) * (-1)
            print("The estimated DOA using T3 is: ", relative_angle_gccPhat_T3 )
        else:
            relative_angle_gccPhat_T3 = (180 - angle_gccPhat_T3) * (-1)
            print("The estimated DOA using T3 is: ", relative_angle_gccPhat_T3 )

        ######
        cos_domain_check = abs(T2) * 343 
        if cos_domain_check < d23:
            angle_gccPhat = math.degrees(math.acos(abs(T2) * 343 / d23))
            relative_angle_gccPhat = (180 - angle_gccPhat) * (-1)
        else:
            angle_gccPhat = math.degrees(math.acos(abs(T1) * 343 / d13))
            # relative_angle_gccPhat = (180 - angle_gccPhat) * (-1)
            relative_angle_gccPhat = (90 + angle_gccPhat)*(-1)
        ...
        angle_ch2_gccPhat = math.degrees(math.acos(d23/ d12))
        ...
        if cos_domain_check_T2 < d23:
            angle_gccPhat_T2 = math.degrees(math.acos(abs(T2) * 343 / d23))
            relative_angle_gccPhat_T2 = (angle_gccPhat_T2)*(-1)
            print("The estimated DOA using T2 is: ", relative_angle_gccPhat_T2 )
        else:
            print("It has Math Domain Error in T2")
        ...
        if T3>0:
            relative_angle_gccPhat = (angle_gccPhat-angle_ch2_gccPhat)*(-1)
        elif  T3<0:
            angle_ch1_plus = 90 - (angle_gccPhat- (90-angle_ch2_gccPhat))
    ...
    #     if (cos_domain_check)<d13: 
    #         angle_gccPhat = math.degrees(math.acos(abs(T1) * 343 / d13))
    #         relative_angle_gccPhat = (90 - angle_gccPhat)
    #     else:
    #         angle_gccPhat = math.degrees(math.acos(abs(T2) * 343 / d23))
    #         relative_angle_gccPhat = angle_gccPhat  
        ...
        if cos_domain_check_T1 < d13:
            angle_gccPhat_T1 = math.degrees(math.acos(abs(T1) * 343 / d13))
            relative_angle_gccPhat_T1 = (90 - angle_gccPhat_T1)
            print("The estimated DOA using T1 is: ", relative_angle_gccPhat_T1 )
        else:
            print("It has Math Domain Error in T1")
        ...
        if cos_domain_check_T2 < d23:
            angle_gccPhat_T2 = math.degrees(math.acos(abs(T2) * 343 / d23))
            relative_angle_gccPhat_T2 = angle_gccPhat_T2
            print("The estimated DOA using T2 is: ", relative_angle_gccPhat_T2 )
        else:
            print("It has Math Domain Error in T2")

        #Use T3
        if cos_domain_check_T3 < d13:
            angle_gccPhat_T3 = math.degrees(math.acos(abs(T3) * 343 / d12))
            angle_gccPhat_T2 = math.degrees(math.acos(abs(T1) * 343 / d23))
            if angle_gccPhat_T2 < angle_ch2:
                relative_angle_gccPhat_T3 = 90 - angle_ch1 - angle_gccPhat_T3
                print("The estimated DOA using T3 is: ", relative_angle_gccPhat_T3 )
            else:
                # relative_angle_gccPhat_T3 = 90 - (angle_ch1 - angle_gccPhat_T3)
                relative_angle_gccPhat_T3 = angle_ch1 + angle_gccPhat_T2
                print ("The estimated DOA using T3 is: ", relative_angle_gccPhat_T3 )
        ...
        if cos_domain_check_T1 < d13:
            ...
            print("It has Math Domian Error in T1")
        ...
        if cos_domain_check_T2 < d23:
            ...
            print("It has Math Domian Error in T2")

        #Use T3
        if cos_domain_check_T3 < d12:
            angle_gccPhat_T3 = math.degrees(math.acos(abs(T3) * 343 / d12))
            relative_angle_gccPhat_T3 = angle_ch2 - angle_gccPhat_T3
            print("The estimated DOA using T3 is: ", relative_angle_gccPhat_T3 )
        else:
            print("It has Math Domian Error in T3")
